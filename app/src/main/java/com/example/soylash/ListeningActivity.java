...
public class ListeningActivity extends AppCompatActivity {
    ...
    private void setupOptions(List<String> options, String correctAnswer) {
        ...
        for (String option : options) {
            ...
            params.width = 0; // Используем вес
            params.height = GridLayout.LayoutParams.WRAP_CONTENT;
            params.columnSpec = GridLayout.spec(GridLayout.UNDEFINED, 1f); // Вес столбца
            params.rowSpec = GridLayout.spec(GridLayout.UNDEFINED, 1f); // Вес строки
    ...
    private void synthesizeAndPlay(String text) {
        ...
        // Используйте retrofit2.Callback вместо okhttp3.Callback
